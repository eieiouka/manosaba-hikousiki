  ...
  return (
    <section id="characters" className="characters">
      ...
      <article className="character-feature">
        ...
        <div className="character-text">
          <p className="character-label">囚人番号 667</p>
          <h3>橘 シェリー</h3>
          <p className="character-desc">
            読み：ゴリラ　ヨウセイ<br />
      ...
      <article className="character-feature">
        ...
        <div className="character-text">
          ...
          <p className="character-desc">
            ...
            黒幕の権力を利用して皆殺しにしようとするも、魔女化した桜羽エマのシネシネ攻撃に屈して、熱々に調理したタルトの具材にされてしまう。（左写真）<br />
      ...
      <article className="character-feature">
        ...
        <div className="character-text">
          <p className="character-label">囚人番号 639</p>
          <h3>黒部 ホノカ</h3>
          <p className="character-desc">
            読み：クロベ　ホノカ<br />
            画像右のキャラクター。黒部ナノカ（画像左）の姉である。<br />
            平穏な家庭だったが、姉が変身の魔法でカンニングして、テストで良い点を取り始めたことで狂い始める。両親がシオンに多額の教育費を投じるようになり、その影響はナノカにも及んだ。シオンはカンニングで両親の期待に応えるが、ナノカの魔法「幻視」は不安定で、発動せずに成績不振に陥ることも少なくなかった。<br />
            姉妹ともに進学校に合格したが、そこから成績の差が顕著になる。ナノカは勉強についていけなくなり、魔法が発動しないタイミングで赤点を取るようになってしまった。常に（カンニングで）満点を取るシオンと比べられ、ナノカは両親から教育虐待を受けるようになる。そのたびに、シオンが替え玉で追試を受けて難を逃れてきた。<br />
            ナノカが家に引きこもるようになると、両親はナノカを見捨ててシオンに期待を寄せるように。だが、シオンが牢屋敷に拉致されてから状況がさらに悪化する。ナノカは出来損ないとして父から暴力を受けるようになってしまう。<br />
            家庭がネグレクト気味になり、家事や裁縫、料理などはナノカが行うように。たまに両親の目を盗んでお菓子を作るのがささやかな楽しみだった。<br />
            父から受けた暴力で傷がついた腕を隠すべく、この頃から長袖の服を着るようになる。幼少期の幸せな家庭を思い出しては、諍いばかりの家庭環境に絶望する日々だった。<br />
            ナノカはシオンを拉致した牢屋敷運営を恨んでおり、あるとき自分も乗り込むことにした。だが、その頃にはシオンは「なれはて」になっており、幸せな再会が果たされることはなかった。
          </p>
        </div>
      </article>
    </section>
